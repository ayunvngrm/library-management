...
public class EditBook extends javax.swing.JFrame {
    ...
    public void setFields(int id, String title, String author, String isbn, String genre, int stock) {
    ...
    private void initComponents() {
        ...
        jPanel3.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 500, 150, 30));
    ...
    private void editDataClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editDataClicked
        try {
            String query = "UPDATE book SET title = ?, author = ?, isbn = ?, genre = ?, stock = ? WHERE id = ?";
